  ...
  return (
    ...
    >
      <div className=" p-4 flex flex-col justify-center items-center h-full">
        ...
        <p className=" text-slate-500 dark:text-slate-300 text-3xl tracking-wider my-8 text-center italic">
        ...
        <div className=" w-full flex justify-center gap-10 ">
          <ProjectsLink />
          <a
            className=" rounded-xl text-3xl px-6 py-5 bg-teal-900 font-semibold text-slate-200"
