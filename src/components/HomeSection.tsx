  ...
  return (
    ...
    >
      <div className=" lg:p-4 flex flex-col justify-center items-center h-full">
        <p className=" text-5xl lg:text-6xl">👋</p>
        <h1 className=" bg-gradient-to-r from-fuchsia-400 via-purple-700 to-violet-900 text-transparent bg-clip-text text-3xl lg:text-5xl font-bold">
          I&apos;m Solomon Kusi-Appiah.
        </h1>
        <p className=" text-slate-500 dark:text-slate-300 text-lg lg:text-2xl tracking-wider my-8 text-center italic">
        ...
        <div className=" w-[60%] flex flex-col lg:flex-row gap-6 justify-center lg:gap-10 ">
          <ProjectsLink />
          <a
            className=" rounded-xl text-center text-lg lg:text-2xl px-3 py-3 lg:px-6 lg:py-5 bg-teal-900 font-semibold text-slate-200"
