        ...
        <div className="mt-16">
          ...
          >
            {expertise.map(({ title, description, image }) => (
              ...
              >
                <div className="  mb-6  w-full h-[30vh] relative">
                  <Image
                    alt="reactjs image"
                ...
                <div className="p-6 text-center">
                  <div className="text-2xl font-semibold group-hover:bg-gradient-to-r from-orange-500 via-pink-600 to-fuchsia-600 group-hover:bg-clip-text group-hover:text-transparent ">{title}</div>
